...
class Arr {
	...
	/**
	 * Retrieve a single key [reference] from an array. If the key does not exist in the
	 ...
	 *     $ref = &Arr::get($_array, 'key');
	 *
	 * @param   array   array to extract from
	 * @param   string  key name
	 * @param   mixed   default value
	 * @return  mixed reference of value
	 */
	...
	/**
	 * Remove Array empty values
	 * 
	 * @param Array $v, Array
	 * @return Array , cleaned Array
	 */
	public static function filterEmpty($v){
		$_v = array_filter($v,function ($val){
